export default {
  ...
  'home.stat.task-num': '任务数',
  'home.stat.gross-premium': '总保费',
  'home.stat.sum-insured':'总保额',
  'home.card-title.last-task': '最新任务',
  'home.card-title.all-task': '全部任务',
  'home.card-title.navigation': '便捷导航',
  'home.card-title.activities': '动态',
  'home.card-title.statistics': '统计',
  'home.button.new-task': '录入要约'
}
