  ...
  <page-header-wrapper>
    ...
    <template v-slot:extraContent>
      <div class='extra-content'>
        <div class='stat-item'>
          <a-statistic title='项目数' :value='99' />
        </div>
        <div class='stat-item'>
          <a-statistic title='总保费' :value='99999.99' />
        </div>
        <div class='stat-item'>
          <a-statistic title='总保额' :value='99999.99' />
        </div>
      </div>
    </template>
            ...
            <a-list>
              <a-list-item :key='index' v-for='(item, index) in activities'>
                <a-list-item-meta>
                  ...
                  <div slot='title'>
                    <span>{{ item.user.nickname }}</span>&nbsp;<span>{{ item.project.action }}</span>&nbsp;项目&nbsp;<a href='#'>{{ item.project.name }}</a>
                  </div>
        ...
        <a-col
          ...
          <a-card title='便捷导航' style='margin-bottom: 24px' :bordered='false' :body-style='{padding: 0}'>
            <div class='item-group'>
              <a-button size='small' type='primary' ghost icon='edit'>录入要约</a-button>
            </div>
          </a-card>
          <a-card
            title='项目比例'
